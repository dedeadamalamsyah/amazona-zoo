...
<body>
	...
	<div class="header-banner">
		<div class="container">
			<div class="head-banner" style="background-color: #ff9541;">
			...
			<div class="banner-grids">
				<div class="col-md-6 banner-grid" style="background-color: #ff9541;">
	...
	<div class="content">
		<div class="welcome">
			<div class="container">
				<h2 style="color: black;">welcome to amazona zoo</h2>
				<div class="welcome-grids">
					...
					?>
						<div class="col-md-3 welcome-grid">
							...
							<div class="wel-info">
								<h4><a href="animal-detail.php?anid=<?php echo $row['ID']; ?>"><?php echo $row['AnimalName']; ?><br>(<?php echo $row['Breed']; ?>)</a></h4>
		...
		<div class="animals">
			<div class="container">
				<h3 style="color: black;">animals</h3>
				<div class="clients">
					<ul id="flexiselDemo3">
						<?php
